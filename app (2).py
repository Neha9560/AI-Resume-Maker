...
wnat latest job news in using tavily,
try top 10 search or whaterver available
and give result like naukri theme design with
job name, jobs desc, salary,
...
if st.button('generate resume'):
  with st.spinner("runnign agent"):
    ...
    st.html(job_code ,width='strech" , unsafe_allow_javascript=True)
